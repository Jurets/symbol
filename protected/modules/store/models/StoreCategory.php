...
class StoreCategory extends BaseModel
{
    ...
    public function relations()
    {
        return array(
            ...
            'categoryAttributeRelation'           => array(self::HAS_MANY, 'StoreCategoryAttribute', 'category_id'),
            'storeCategoryAttributes'             => array(self::HAS_MANY, 'StoreAttribute', array('attribute_id'=>'id'), 'through'=>'categoryAttributeRelation', 'scopes'=>'applyTranslateCriteria'),
        );
    }
    ...
    {
        // Clear all relations
        Storecategoryattribute::model()->deleteAllByAttributes(array('category_id'=>$this->id));
        ...
        foreach($attributes as $attribute_id)
        {
            if($attribute_id)
            {
                $record = new Storecategoryattribute;
                $record->category_id = $this->id;
