 ...
 * @property string $sort  // ADDED 12.11.2013
...
class StoreProduct extends BaseModel
{
	...
	public function rules()
	{
		return array(
			...
			array('price, type_id, manufacturer_id, is_slider', 'numerical'),
			...
			array('name, url, meta_title, meta_keywords, meta_description, layout, view, sku, sort', 'length', 'max'=>255),
			array('short_description, full_description, auto_decrease_quantity', 'type'),
			// Search
			array('id, name, url, price, short_description, full_description, created, updated, manufacturer_id, sort', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
            ...
            'is_slider'              => Yii::t('StoreModule.core', 'В слайдере'),
            ...
            'sort'                   => Yii::t('StoreModule.core', 'Сортировка')   ,
