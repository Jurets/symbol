				...
				<td width="50%">
					...
					<div class="userData">
                        ...
                        <div class="row">
                            ...
                            <?php echo CHtml::activeTextField($model,'user_country'); ?>
                        </div>

                        <div class="row">
                            <?php echo CHtml::activeLabel($model,'user_city'); ?>
                            <?php echo CHtml::activeTextField($model,'user_city'); ?>
                        </div>
                        ...
                        <div class="row">
                            <?php echo CHtml::activeLabel($model,'user_house'); ?>
                            <?php echo CHtml::activeTextField($model,'user_house'); ?>
                        </div>
