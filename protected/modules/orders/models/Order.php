 ...
 * @property smallint $delivery_time_from
 * @property smallint $delivery_time_to
...
class Order extends BaseModel
{
	...
	{
		return array(
			array('user_name, user_phone, user_country, user_city, user_house', 'required'),
			array('user_name, user_email, user_country, user_city, user_house', 'length', 'max'=>100),
            array('delivery_time_from, delivery_time_to','numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'delivery_id'    => Yii::t('OrdersModule.core','Способ оплаты'), // renamed to pay instead of delivery
            ...
            'user_house'     => Yii::t('OrdersModule.core','Дом-Корпус-Кварира'),
